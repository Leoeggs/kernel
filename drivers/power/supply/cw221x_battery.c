...
#define USER_RSENSE             10000  /*lgh modify*/
...
static unsigned char config_profile_info[SIZE_OF_PROFILE] = {
	...
	//lgh add new profile 2023-3-28
	0x32,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0xB2,0xC2,0xB5,0xAF,0x9D,0x98,0xF4,0xEB,
	0xE9,0xB8,0xA5,0x93,0x84,0x66,0x58,0x4E,
	0x47,0x46,0x44,0x8C,0x8C,0xD2,0xFC,0xFF,
	0xDE,0x7A,0x6B,0xBE,0xD7,0xD1,0xBF,0xB5,
	0xC0,0xC8,0xCC,0xC7,0xC1,0xB1,0xAA,0xB2,
	0xC2,0xD0,0xC7,0xD6,0xEE,0xFF,0xFF,0x6E,
	0x20,0x00,0xAB,0x10,0x00,0xB0,0x71,0x00,
	0x00,0x00,0x64,0x28,0xD3,0x74,0x00,0x00,
...
static int cw221X_get_state(struct cw_battery *cw_bat)
{
	...
	//lgh for (i = 0; i < SIZE_OF_PROFILE; i++) {
		for (i = 0; i < 0xff; i++) {
