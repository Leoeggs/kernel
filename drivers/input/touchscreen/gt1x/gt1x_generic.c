...
u8 gtp_dat_918[] = 
{
//#include "GT917S_Config_20190918_0201.cfg"
#include "LC0324-GT1151Q_Config_20201119_161411.cfg"
};
...
s32 gt1x_init_panel(void)
{
	...
	memset(gt1x_config, 0, sizeof(gt1x_config));
	memcpy(gt1x_config, gtp_dat_918, CFG_GROUP_LEN(gtp_dat_918));
...
s32 gt1x_touch_event_handler(u8 *data, struct input_dev *dev, struct input_dev *pen_dev)
{
	...
	GTP_DEBUG("touch_num:%d",touch_num);
